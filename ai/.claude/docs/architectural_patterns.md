...
Node names are module constants (graph.py:62-71); specialist node names are the values of the
`Specialist` enum (state.py:43), and `SPECIALISTS` derives from it (graph.py:75). Tests import the constants
